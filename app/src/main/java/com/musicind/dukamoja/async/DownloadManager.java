        ...
        try {
            if (downloadFileUrl != null) {
                ...
                if (lastIndex > -1) {
                    ...
                    File downloadDirectory = Environment.getExternalStoragePublicDirectory(downloadDirectoryName);
                    ...
                    if (!ret.exists()) {
                        ...
                        if(ret.isFile())
                        {
                        clickListener.onShowToast("File exist!!");
                        Log.e(DownloadUtil.TAG_DOWNLOAD_MANAGER, "File exist");
                    }
                }
            }
