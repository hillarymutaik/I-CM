...
import static com.musicind.dukamoja.util.Constants.CHRONOMETER_FULL_DURATION;
import static com.musicind.dukamoja.util.Constants.KEY_SEEK_BAR_PROGRESS;
import static com.musicind.dukamoja.util.Constants.LAST_CATEGORY;
import static com.musicind.dukamoja.util.Constants.MEDIA_QUEUE_POSITION;
import static com.musicind.dukamoja.util.Constants.NOW_PLAYING;
import static com.musicind.dukamoja.util.Constants.PLAYLIST_ID;
import static com.musicind.dukamoja.util.Constants.RECORDS_CROWN;
import static com.musicind.dukamoja.util.Constants.RECORDS_OPERATIVE;
import static com.musicind.dukamoja.util.Constants.RECORDS_ORAL;
import static com.musicind.dukamoja.util.Constants.RECORDS_ORTHO;
import static com.musicind.dukamoja.util.Constants.RECORDS_PEDO;
import static com.musicind.dukamoja.util.Constants.RECORDS_PHARMA;
import static com.musicind.dukamoja.util.Constants.RECORDS_PROSTHESIS;
import static com.musicind.dukamoja.util.Constants.SPEED_INDEX;
